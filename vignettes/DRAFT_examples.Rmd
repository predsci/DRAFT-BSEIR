...
```{r}
# San Diego 2017-2018 data is included in package as 'incidence_data1'
...
To run DRAFT, execute the following line in an R console.  It will take a minute or two to execute the MCMC fitting procedure.  The function will create a subdirectory and save results .RData and .png files there.
#```{r, results="hide"}
```{r, eval=F}
